...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-08-22 13:56:55 by crocha-s          #+#    #+#             */
/*   Updated: 2025-08-22 13:56:55 by crocha-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Channel
{
	private:
		...
		void _broadcastToChannel(Server *server, const std::string &message, int exclude_fd = -1);
